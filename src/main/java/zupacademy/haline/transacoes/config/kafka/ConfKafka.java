package zupacademy.haline.transacoes.config.kafka;
...
import zupacademy.haline.transacao.TransacaoTopicMessage;

import java.util.HashMap;
import java.util.Map;

@Configuration
public class ConfKafka {

    private final KafkaProperties kafkaProperties;

    public ConfKafka(KafkaProperties kafkaProperties) {
